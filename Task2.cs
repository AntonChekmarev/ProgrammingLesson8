namespace Task2
{
    public class Task
    {
        ...
        {
            PrintStartTask("56", "на входе размерность матрицы, на выходе матрица случайных целых чисел и номер строки с наименьшей суммой элементов");
            ...
            Console.WriteLine();
            Console.WriteLine("Номер строки с наименьшей суммой элементов: " + (RowNumberWithMinimumAmount(array) + 1));
        ...
        /// <summary>
        /// получение номера строки в матрице с наименьшей суммой элементов
        /// </summary>
        /// <param name="array">матрица</param>
        /// <returns></returns>
        int RowNumberWithMinimumAmount(int[][] array)
        {
            int rezult = 0;
            int minsumm = 0;
            int tempmsumm = 0;
            ...
            {
                tempmsumm = array[i].Sum(); // сумма строки
                if (i == 0 || tempmsumm < minsumm) { minsumm = tempmsumm; rezult = i; }
            }
